...
public class AuthenticationProcessFilter extends OncePerRequestFilter {
    ...
    private static final String NO_CHECK_URL = "/auth/login"; // "/auth/login"으로 들어오는 요청은 Filter 작동 X

    @Override
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        // "/auth/login"으로 들어오는 요청은 accessToken 검증 및 authenticate X
    ...
    public void checkAccessTokenAndAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        jwtService.extractAccessToken(request)
                ...
                .ifPresent(accessToken -> jwtService.extractEmail(accessToken)
                        .ifPresent(email -> memberRepository.findActiveByEmail(email)
